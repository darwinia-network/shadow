...
var doc = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/core.GetEthHeaderWithProofByNumberJSONResp"
                        },
                        "headers": {
                            "Token": {
                                "type": "string",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/core.GetEthHeaderByNumberParams"
                        },
                        "headers": {
                            "Token": {
                                "type": "string",
    ...
    "definitions": {
        ...
        "core.GetEthHeaderByNumberParams": {
            "type": "object",
            "properties": {
                "number": {
                    "type": "integer"
        ...
        "core.GetEthHeaderWithProofByNumberJSONResp": {
            "type": "object",
            "properties": {
                "eth_header": {
                    "type": "object",
